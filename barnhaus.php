...
<title> VISITORIA | Barnhaus </title>
<link href="https://fonts.googleapis.com/css2?family=Lobster&display=swap" rel="stylesheet">
<link rel="stylesheet" href="css/barnhaus.css">
...
<div class="body-child1">
  <div class="child1-text">
    ...
    <h4 class="child1-location">
      <i class="fa fa-location">Jibert, jud. Brasov</i> 
    </h4>
...
<div class="description">
  ...
  <h2 id="child2-property"> BARNHAUS </h2>
  <hr>
...
<div class="details">
  <div class="utilities">
    <ul cless="list-utilities">
      ...
      <hr>
      <li> <i class="fa fa-house"></i> 5 BEDROOMS</li>
      <hr>
      <li> <i class="fa fa-bath"></i> 3 BATHROOMS</li>
      <hr>
      <li> <i class="fa fa-toilet"></i> 1 WC</li>
      <hr>
...
<div class="gallery-wrap">
  ...
  <div class="clr"></div>
    ...
    <div id="#image-1" class="gallery-image exterior">  
        <a href="#image-1"> <img src="img/barnhaus/outdoor/1.webp" /></a>
    </div>

    <div class="lb-overlay" id="image-1"> 
        <img src="img/barnhaus/outdoor/1.webp"/>
        <div> 
    ...
    <div id="#image-2" class="gallery-image exterior">  
        <a href="#image-2"> <img src="img/barnhaus/outdoor/2.webp" /></a>
    </div>
    <div class="lb-overlay" id="image-2"> 
        <img src="img/barnhaus/outdoor/2.webp"/>
        <div> 
    ...
    <div id="#image-3" class="gallery-image exterior">  
        <a href="#image-3"> <img src="img/barnhaus/outdoor/3.webp" /></a>
    </div>
    <div class="lb-overlay" id="image-3"> 
        <img src="img/barnhaus/outdoor/3.webp"/>
        <div> 
  ...
  <div class="gallery-image exterior" onclick="lightbox(3)"> 
    <a href="#image-4">
        <img src="img/barnhaus/outdoor/4.jpg" alt="" />
    </a>
  </div>
  ...
  <div class="lb-overlay" id="image-4"> 
        <img src="img/barnhaus/outdoor/4.jpg"/>
        <div> 
    ...
    <div class="gallery-image interior" onclick="lightbox(4)">
        <a href="#image-5"> 
            <img src="img/barnhaus/indoor/5.jpg" alt="" />
        </a>
    </div>

  <div class="lb-overlay" id="image-5"> 
    <img src="img/barnhaus/indoor/5.jpg" />
    <div> 
  ...
  <div class="gallery-image interior" onclick="lightbox(5)"> 
    <a href="#image-6">
        <img src="img/barnhaus/indoor/6.webp" alt="" />
    </a>
</div>

  <div class="lb-overlay" id="image-6"> 
    <img src="img/barnhaus/indoor/6.webp"/>
    <div> 
  ...
  <div class="gallery-image interior" onclick="lightbox(6)"><a href="#image-7"> <img src="img/barnhaus/indoor/7.webp" alt="" /></a></div>

  <div class="lb-overlay" id="image-7"> <img src="img/barnhaus/indoor/7.webp"/>
  ...
  <div class="gallery-image interior" onclick="lightbox(7)"><a href="#image-8"> <img src="img/barnhaus/indoor/8.webp" alt="" /></a></div>
 
  <div class="lb-overlay" id="image-8"> <img src="img/barnhaus/indoor/8.webp"/>
    ...
    <div class="gallery-image bedrooms"><a href="#image-9"> <img src="img/barnhaus/bedroom/9.jpg" alt="" /></a></div>
 
  <div class="lb-overlay" id="image-9"> <img src="img/barnhaus/bedroom/9.jpg"/>
    ...
    <div class="gallery-image bedrooms"><a href="#image-10"> <img src="img/barnhaus/bedroom/10.jpg" alt="" /></a></div>
 
  <div class="lb-overlay" id="image-10"> <img src="img/barnhaus/bedroom/10.jpg"/>
    ...
    <div class="gallery-image bedrooms"><a href="#image-11"> <img src="img/barnhaus/bedroom/11.webp" alt="" /></a></div>
 
  <div class="lb-overlay" id="image-11"> <img src="img/barnhaus/bedroom/11.webp"/>
    ...
    <div class="gallery-image bedrooms"><a href="#image-12"> <img src="img/barnhaus/bedroom/12.jpg" alt="" /></a></div>
 
  <div class="lb-overlay" id="image-12"> <img src="img/barnhaus/bedroom/12.jpg"/>
